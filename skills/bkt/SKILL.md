...
| Go | `go install github.com/alessandro308/bitbucket-cli/cmd/bkt@latest` |
| Binary | Download from [GitHub Releases](https://github.com/alessandro308/bitbucket-cli/releases) |
