...
LDFLAGS := -s -w \
	-X github.com/alessandro308/bitbucket-cli/internal/build.versionFromLdflags=$(VERSION) \
	-X github.com/alessandro308/bitbucket-cli/internal/build.commitFromLdflags=$(COMMIT) \
	-X github.com/alessandro308/bitbucket-cli/internal/build.dateFromLdflags=$(BUILD_DATE)
